            ...
            children: [
              {
                id: 'ins-life-pre',
                label: 'Pre-Licensing',
                description: '52 Hours Total (20 Life + 20 Accident/Health + 12 Ethics).',
                icon: <BookOpen size={16} />,
              },
              {
                id: 'ins-life-exam',
            ...
            children: [
              {
                id: 'ins-pc-pre',
                label: 'Pre-Licensing',
                description: '52 Hours Total (20 Property + 20 Casualty + 12 Ethics).',
                icon: <BookOpen size={16} />,
              },
              {
                id: 'ins-pc-exam',
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start gap-4">
              ...
              {node.icon && (
                <div
                  className={[
                    'p-2 rounded-full flex items-center justify-center transition-colors flex-shrink-0',
                    isExpanded
            ...
            {hasChildren && (
              <div
                className={`text-champagne transition-transform duration-300 flex-shrink-0 ml-4 ${
